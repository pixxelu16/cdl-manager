      ...
      <div class="from-all">
         <form method="POST" action="{{ route('register') }}">
            ...
            <div class="input-row">
               ...
               <input id="dot_number" type="text" class="form-control @error('dot_number') is-invalid @enderror" name="dot_number" value="{{ old('dot_number') }}" required autocomplete="dot_number" autofocus>
               @error('dot_number')
               <span class="invalid-feedback" role="alert">
               <strong>{{ $message }}</strong>
               </span>
